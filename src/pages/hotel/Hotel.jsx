        ...
        <div>
            ...
            <div className='hotelContainer'>
                ...
                <div className='hotelWrapper'>
                    ...
                    <div className='hotelImages'>{/* map thru photos */}</div>
                    <div className='hotelDetails'>
                        <div className='hotelDetailsTexts'>
                            ...
                            <p className='hotelDesc'>
                                ...
                                microwave, a flat-screen TV, and a private bathroom with shower and a hairdryer. A fridge is also offered, as well as
                                an electric tea pot and a coffee machine. Popular points of interest near the apartment include Cloth Hall, Main
                                Market Square and Town Hall Tower. The nearest airport is John Paul II International Kraków–Balice, 16.1 km from Tower
